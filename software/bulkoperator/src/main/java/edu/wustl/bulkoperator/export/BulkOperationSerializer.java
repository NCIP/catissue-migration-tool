package edu.wustl.bulkoperator.export;

import static edu.wustl.bulkoperator.export.XmlUtil.writeElement;
import static edu.wustl.bulkoperator.export.XmlUtil.writeElementEnd;
import static edu.wustl.bulkoperator.export.XmlUtil.writeElementStart;
