...
public class DBManagerImpl
{
	...
	public static Connection getConnection() throws BulkOperationException {
		...
		String dbCredentialsFileName = bulkOprProp.getProperty(BulkOperationConstants.DATABASE_CREDENTIALS_FILE);
		Properties properties = BulkOperationUtility.getPropertiesFile("./" + dbCredentialsFileName);
